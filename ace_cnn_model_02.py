...
class ace_cnn_model():
    ...
    def __init__(self, sentence_length=30, num_labels=10, vocab_size=2048, word_embedding_size=100,
                 pos_embedding_size=10, filter_sizes=[3, 4, 5], filter_num=100, batch_size=2):
        """
        ...
        with tf.device('/gpu:0'), tf.name_scope("word_embedding_layer"):
            ...
            intput_sentence_vec = tf.concat(2, [input_word_vec, input_t_pos_vec, input_c_pos_vec])
